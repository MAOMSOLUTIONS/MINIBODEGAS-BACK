...
def create_reservation():
    ...
    print("Datos recibidos en create_reservation:", data)
    ...
    try:
        ...
        reservation = Reservation(
            ...
            reservation_deposit_amount=data['reservation_deposit_amount'],
            reservation_total_amount=data['reservation_total_amount'],
            reservation_amount_paid=data['reservation_amount_paid'],
        ...
        # Determinar el estado de la reserva basado en el monto pagado
        ...
        db.session.rollback()
        return jsonify({'error': 'Error al crear la reserva. Verifica los datos enviados.'}), 400
...
def update_reservation(id):
    ...
    print("actualizacion de la reservacion",data)  # Depuración de los datos recibidos
    ...
    try:
        ...
        payment_due_date_str = data.get('payment_due_date', None)
        if payment_due_date_str:
            reservation.payment_due_date = datetime.strptime(payment_due_date_str, "%Y-%m-%d")  # Actualizar la fecha de pago
